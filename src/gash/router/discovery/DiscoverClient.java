...
public class DiscoverClient {
	    ...
	    try {
	        ...
	        while (interfaces.hasMoreElements()) {
	            ...
	            while(addresses.hasMoreElements()) {
	                ...
	                //System.out.println(iface.getDisplayName() + "Local IP:  " + ip);
	                //return(ip);
	            }
	            return ip;
	        }
    ...
    public static void checkHosts() throws UnknownHostException, IOException{
        ...
        for (int i = 1; i <= 254; i++)
        {
            ...
            else
            {
                ...
                System.out.println(" Not Resolved : "+address.getHostAddress());
            }
        }
    }
